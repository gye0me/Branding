...
export const allProducts = [
  ...
  { id: 3, category: 'PPT', title: "비즈니스 프레젠테이션 템플릿", user: "장코가", price: 8000, temp: "41.2°C", tag: null, bgColor: "bg-[#E76F51]" },
  { id: 4, category: 'PPT', title: "발표회 전문 디자인 팩", user: "김레이", price: 10000, temp: "40.8°C", tag: "인기", bgColor: "bg-[#2A9D8F]" },
  { id: 5, category: 'PPT', title: "학술발표 PPT 양식", user: "윤아도", price: 6000, temp: "69.5°C", tag: "신규", bgColor: "bg-[#F4A261]" },
  {
    id: 6,
    category: '노션',
  ...
  { id: 7, category: '노션', title: "시험기간용 플래너", user: "장레오", price: 5000, temp: "16.2°C", tag: "인기", bgColor: "bg-[#E76F51]" },
  { id: 8, category: '노션', title: "일정관리 데이터베이스", user: "양세나", price: 7000, temp: "14.1°C", tag: "추천", bgColor: "bg-[#2A9D8F]" },
  { id: 9, category: '자소서', title: "자소서 작성 가이드 + 예제", user: "염유나", price: 11000, temp: "42.3°C", tag: null, bgColor: "bg-[#F4A261]" },
  { id: 10, category: '자소서', title: "합격 자소서 8개 모음", user: "이예온", price: 13000, temp: "39.7°C", tag: null, bgColor: "bg-[#E76F51]" },
  { id: 11, category: '자소서', title: "무조건 합격하는 자기소개 작성법", user: "정동욱", price: 10000, temp: "50.8°C", tag: "인기", bgColor: "bg-[#1FBA9E]" },
  { id: 12, category: '인스타그램', iconCategory: '노션', title: "인스타 피드 디자인 템플릿", user: "윤민희", price: 8500, temp: "12.4°C", tag: "추천", bgColor: "bg-[#2A9D8F]" },
  { id: 13, category: '인스타그램', iconCategory: '자소서', title: "릴스 제작 가이드", user: "배성현", price: 7500, temp: "20.1°C", tag: "인기", bgColor: "bg-[#F4A261]" },
  { id: 14, category: '인스타그램', iconCategory: '노션', title: "느좋 게시글 만드는 법", user: "오시온", price: 9500, temp: "71.6°C", tag: "신규", bgColor: "bg-[#1FBA9E]" },
];
